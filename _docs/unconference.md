...
(../assets/lightning-rod.png "Lightning Rod is Awesome!")
...
The conference cost (travel, hotel, etc) is split evenly between all advisers, whether or not you attend. That way there's not much economic incentive to skip the conference (as in "I'm a bit low on cash now, so I'm skipping the conference"). You pay either way so you might as well attend :)
